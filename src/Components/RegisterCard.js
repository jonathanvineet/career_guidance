        ...
        <div className="w-full min-h-screen flex items-center justify-center relative p-6">
            <div className="relative z-10 w-[460px] glass border border-white/10 rounded-[2.5rem] px-12 py-16 shadow-4xl animate-fadeInUp relative overflow-hidden group">
                ...
                <div className="text-center mb-12 relative z-10">
                    ...
                    <div>
                        <h2 className="text-4xl font-black text-white mb-3">Join the Future.</h2>
                        <p className="text-white/40 font-medium">Initialize your professional trajectory.</p>
                    </div>
                </div>
                ...
                <form className="flex flex-col gap-6 w-full relative z-10">
                    ...
                    <div className="relative group/input">
                        ...
                        <input
                            ...
                            required
                        />
                        <div className="absolute top-1/2 -translate-y-1/2 right-5 text-purple-400/50 text-xl cursor-pointer hover:text-white transition-all" onClick={handleIcons}>
                ...
                <div className="text-center mt-10 relative z-10">
                    <p className="text-white/40 font-medium">
                        Already linked? <Link to="/auth/signin" className="font-black text-purple-400 hover:text-pink-400 transition-colors ml-1">Initiate Protocol</Link>
                    </p>
                </div>
            </div>
        </div>
